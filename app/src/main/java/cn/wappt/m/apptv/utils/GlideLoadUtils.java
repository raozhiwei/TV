...
public class GlideLoadUtils {
     ...
     */
    public void glideLoads(Context context, String url, ImageView imageView, RequestOptions options,int w, int h) {
        if (context != null ) {
            Glide.with(context)
                    .load(url)
                    .apply(options.override(w,h))
                    .into(imageView);
    ...
    public void glideLoads(Activity activity, String url, ImageView imageView, RequestOptions options,int w, int h) {
    ...
    public void glideLoads(Fragment fragment, String url, ImageView imageView, RequestOptions options,int w, int h) {
    ...
    public void glideLoads(android.app.Fragment fragment ,String url, ImageView imageView, RequestOptions options,int w, int h) {
        if (fragment != null && fragment.getActivity() != null) {
            Glide.with(fragment)
                    .load(url)
                    .apply(options.override(w,h))
